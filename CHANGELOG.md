...
- Added a new rule for silver coins. They'll likely wander into the currency tierlist if trial goes core.
...
- Delayed until next patch, it was giving us too many technical difficulties with existing filterblade savestates: ~~Moved ritual and crescent splinters into their own category out of currency~~
